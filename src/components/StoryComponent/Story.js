...
function Story({ story }) {
  return (
    <div className="flex justify-between m-6">
      <div className="flex flex-col max-w-lg mx-auto rounded-lg shadow-lg">
        <img
        ...
        <div className="flex justify-center">
          <div className="flex items-center p-2 bg-green-logo rounded-lg shadow-xs cursor-pointer hover:bg-green-forhover hover:text-gray-100">
            <svg
            ...
            <div className="flex items-center space-x-3 w-full">
              ...
              <div>
                <Link
                  ...
                  className="hover:text-green-forhover"
                >
