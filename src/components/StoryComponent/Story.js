...
function Story({ story }) {
  return (
    <div className="flex justify-between m-6">
      <div className="flex flex-col h-full max-w-lg mx-auto rounded-lg shadow-lg">
        <img
        ...
        <div className="flex justify-between -mt-4 px-4">
          <span className="inline-block ring-4 bg-green-logo ring-green-logo rounded-full text-sm font-medium tracking-wide text-gray-100 px-3 pt-0.5">
            {story.branch}
          </span>
          <span className="flex h-min space-x-1 items-center rounded-full text-gray-400 bg-gray-800 py-1 px-2 text-xs font-medium">
            <p className="text-green-forhover font-semibold text-xs">
              {story.clubs}
            </p>
          </span>
        </div>
        <div className="py-2 px-4">
          <h1 className="text-xl font-medium leading-6 tracking-wide hover:text-green-forhover cursor-pointer">
            <a href={`/profile/${story.id}`}>{story.name}</a>
          </h1>
        </div>
        ...
        <div className="p-2 flex justify-center ">
          <div className="flex items-center p-4 bg-green-200 rounded-lg shadow-xs cursor-pointer hover:bg-green-500 hover:text-gray-100">
            ...
            <div>
              <p className=" text-xs font-medium ml-2 ">Let's Catch Up!</p>
            </div>
          </div>
        </div>
        <div className="flex flex-row items-end h-full w-full px-4 mt-4">
          <div className="flex border-t w-full py-4">
            ...
            <div className="flex items-center flex-shrink-0 px-2">
              <div className="flex items-center space-x-1 text-gray-400">
                <a href={story?.github_link.String}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <a href={story?.linkedin_link.String}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="text-black hover:text-green-forhover"
                    width="24"
                ...
                <a href={story?.youtube_link.String}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="text-black hover:text-green-forhover"
                    width="24"
